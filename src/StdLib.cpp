...
const std::vector<NativeDescriptor>& makeDescriptors() {
    static const std::vector<NativeDescriptor> descriptors = {
        ...
        {"pow",
         ...
         TypeInfo::makeF64(),
         2},
        {"charCodeAt", {TypeInfo::makeStr(), TypeInfo::makeI64()}, TypeInfo::makeI64(), 2},
        {"charFromCode", {TypeInfo::makeI64()}, TypeInfo::makeStr(), 1},
        {"slice", {TypeInfo::makeStr(), TypeInfo::makeI64(), TypeInfo::makeI64()}, TypeInfo::makeStr(), 3},
