...
| Package | Kind | Kelvra runtime | ABI | Notes |
| --- | --- | --- | --- | --- |
| encoding, json, log, math, path, test | source | ^0.2.0 | — | Portable |
| fs, random, time | native | ^0.2.0 | 3 | Linux x86_64/aarch64; macOS arm64 |
| window | native | ^0.2.0 | 3 | Same targets; SDL2 >= 2.0 |

Kelvra 0.1.4 is the first release whose default source build embeds the correct
runtime version used by `kelvra_runtime` checks. Package CI tests that release as
