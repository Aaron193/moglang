...
| --- | --- | --- | --- | --- |
| encoding, path, json, log, test | source | ^0.1.0 | — | Portable |
| time, random, fs | native | ^0.1.0 | 3 | Linux x86_64/aarch64; macOS arm64/x86_64 |
| window | native | ^0.1.0 | 3 | Same targets; SDL2 >= 2.0 |
