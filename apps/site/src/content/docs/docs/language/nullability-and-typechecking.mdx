...
description: Nullable types, explicit checks, and the kind of compile-time errors Kelvra already enforces.
---

Kelvra is strictly typed by default. The repo has broad type-error coverage, and
