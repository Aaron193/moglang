...
for a standalone C or C++ backed package. It includes the manifest, public Kelvra
...
- [native package template](https://github.com/kelvralang/native-package-template)
- [`github.com/kelvralang/window`](https://github.com/kelvralang/window)
...
Host API v2 lets native code retain Kelvra values, release them, inspect retained
values, and invoke Kelvra callbacks across garbage collections. The runtime rejects
...
Official runtime-maintained packages use the reserved `kelvra:*` canonical package
