...
function protocolMetadata(initializeResult) {
  ...
  const kelvra = result.kelvra || experimental.kelvra || experimental.kelvraTooling || {};
  const raw = kelvra.toolingProtocolVersion ?? kelvra.protocolVersion ?? result.toolingProtocolVersion;
  ...
  return {
    ...
    features: Array.isArray(kelvra.features) ? kelvra.features : []
  };
}
